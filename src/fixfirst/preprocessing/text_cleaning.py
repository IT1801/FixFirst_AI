...
Deliberately conservative: this feeds an ABSA pipeline (transformer + LLM),
both of which benefit from natural sentence structure, casing, and
punctuation. We strip noise (HTML, URLs, control chars, repeated
whitespace) but do NOT lowercase, strip punctuation, or remove stopwords —
that would destroy signal a cased transformer or an LLM prompt relies on.
"""
